...
import styles from "./parotalasimies_header.module.css";
    ...
    <section className={styles.container}>
      ...
      <div className={styles.gridcontainer}>
        ...
        <div className={styles.div6}>
          <div className={styles.title}>PAROTAĻĀSIMIES?</div>
        </div>
...
export default ParotalasimiesHeader;
